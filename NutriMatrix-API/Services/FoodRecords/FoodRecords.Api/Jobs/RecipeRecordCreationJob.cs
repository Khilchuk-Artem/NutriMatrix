...
namespace FoodRecords.Api.Jobs
{
    public class RecipeRecordCreationJob : IJob
    {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            /*await _businessObjectService.CreateObjectAsync(objectType, objectId, amount); // Create object based on type
            _logger.LogInformation("Created {ObjectType} object for schedule {ScheduleId}", objectType, scheduleId);*/
        }
    }
}
